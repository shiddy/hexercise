...
export { computePosition } from './index.d.ts';
export { autoUpdate, AutoUpdateOptions } from './autoUpdate.d.ts';
export { platform } from './platform.d.ts';
export type { AlignedPlacement, Alignment, Axis, ClientRectObject, ComputePositionReturn, Coords, Dimensions, ElementContext, ElementRects, InlineOptions, Length, MiddlewareData, MiddlewareReturn, OffsetOptions, Padding, Placement, Rect, RootBoundary, Side, SideObject, Strategy, } from 'https://esm.sh/v132/@floating-ui/core@1.4.2/src/types.d.ts';
export { offset } from 'https://esm.sh/v132/@floating-ui/core@1.4.2/src/types.d.ts';
